...
const MESSAGES = {
  en: {
    ...
    'trinket.tea_set.hint': '10M tokens · table tea set',
    'trinket.lucky_cat.name': 'Lucky cat',
    'trinket.lucky_cat.hint': '50M tokens · corner stone cat',
    'trinket.wind_chime.name': 'Wind chime',
    'trinket.wind_chime.hint': '100M tokens · eave wind chime',
    'trinket.incense.name': 'Incense burner',
    'trinket.incense.hint': '200M tokens · table incense burner',
  ...
  zh: {
    ...
    'trinket.tea_set.hint': '千万 token · 案前茶具',
    'trinket.lucky_cat.name': '招财猫',
    'trinket.lucky_cat.hint': '5 千万 token · 角落石猫',
    'trinket.wind_chime.name': '风铃',
    'trinket.wind_chime.hint': '亿 token · 檐下风铃',
    'trinket.incense.name': '香炉',
    'trinket.incense.hint': '两亿 token · 案上香炉',
