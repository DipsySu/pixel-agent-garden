...
const copy = {
  ...
  zh_cn: {
    ...
    "faq.1.a": "原生 adapter 已覆盖 Claude Code/Cowork、Codex、Copilot CLI、Cursor、Kiro、Qwen Code、Gemini CLI、Antigravity、OpenCode、Cline 与 Goose；其他来源可使用 manual JSONL。",
  ...
  zh_tw: {
    ...
    "faq.1.a": "原生 adapter 已支援 Claude Code/Cowork、Codex、Copilot CLI、Cursor、Kiro、Qwen Code、Gemini CLI、Antigravity、OpenCode、Cline 與 Goose；其他來源可使用 manual JSONL。",
