...
use crate::adapters::{
    claude_code::ClaudeCodeAdapter, codex::CodexAdapter, manual_jsonl::ManualJsonlAdapter,
};
...
mod tests {
    ...
    #[test]
    fn registry_lists_all_three_phase1_adapters() {
        ...
        assert_eq!(names, vec!["claude-code", "codex", "manual-jsonl"]);
    }
}
